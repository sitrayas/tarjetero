...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-07-2024 a las 06:10:53
...
CREATE TABLE `pacientes` (
  ...
  `nombre_del_padre` varchar(100) DEFAULT NULL,
  `nombre_de_la_madre` varchar(100) DEFAULT NULL,
  ...
  `id_canton` bigint(20) DEFAULT NULL,
...
INSERT INTO `pacientes` (`numero_historia_clinica`, `apellido_paterno`, `apellido_materno`, `nombres`, `primer_nombre`, `segundo_nombre`, `nombre_del_padre`, `nombre_de_la_madre`, `fecha_de_nacimiento`, `sexo`, `cedula`, `direccion`, `fecha_de_ingreso`, `id_provincia`, `id_canton`, `id_parroquia`) VALUES
(1, 'Sit voluptates nulla', 'Ad earum eos exerci', NULL, 'Velit laudantium ni', 'Nam occaecat expedit', 'Ut est aut accusant', 'Et deserunt consequa', '1992-11-27', 'F', '0987654321', 'Culpa temporibus sus', '2024-07-06 04:07:49', 22, 214, 1340),
(2, 'Sit ducimus ex do ', 'Velit tempore enim ', NULL, 'Est sapiente laborio', 'Maxime voluptatem ap', 'Adipisci nulla cumqu', 'Nisi ipsum eos quib', '2023-01-27', 'F', '21234567890', 'Et perspiciatis rer', '2024-07-06 04:08:20', 6, 46, 307),
(3, 'Proident in quos of', 'Vero aliquid nihil v', NULL, 'In distinctio Vitae', 'Est deserunt quod q', 'Fugiat quam culpa d', 'Enim minima quod ex ', '1990-02-15', 'M', '0009988765', 'Enim hic cupidatat o', '2024-07-06 04:08:45', 14, 165, 1005);
...
ALTER TABLE `pacientes`
  ADD PRIMARY KEY (`numero_historia_clinica`),
  ADD KEY `fk_pacientes_provincia` (`id_provincia`),
  ADD KEY `fk_pacientes_canton` (`id_canton`),
  ADD KEY `fk_pacientes_parroquia` (`id_parroquia`);
...
--
ALTER TABLE `pacientes`
  MODIFY `numero_historia_clinica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `pacientes`
  ADD CONSTRAINT `fk_pacientes_canton` FOREIGN KEY (`id_canton`) REFERENCES `tbl_canton` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pacientes_parroquia` FOREIGN KEY (`id_parroquia`) REFERENCES `tbl_parroquia` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pacientes_provincia` FOREIGN KEY (`id_provincia`) REFERENCES `tbl_provincia` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
